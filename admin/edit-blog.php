...
$id=$_GET['id'];
$blogQueryResult=Blog::getBlogInfoByID($id);

$bloginfo =mysqli_fetch_assoc($blogQueryResult);
?>
        ...
        <div class="col-sm-10 col-sm-offset-1">
            <form class="form-horizontal" name="editBlogForm" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="blog_description" cols="30" rows="10" required style="resize: vertical;"  class="form-control" id="inputCategoryDescription" placeholder="Category Description"><?php echo $bloginfo['blog_description']; ?></textarea>
                    </div>
                </div>
